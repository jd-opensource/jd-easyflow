-- This is mysql database schema of process definition、process instance and process task. The java code will open source future. You currently can refer the schema and implement relative function by the extension ability of core function yourself.
