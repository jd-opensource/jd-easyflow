...
(function(J) {
	...
	$.extend(J.msg, {
		...
		"dataviewcfg.configDesc":"Configuration description",
		"dataviewcfg.descTooltip":"Tooltip for the element",
		"dataviewcfg.modifyOnAdd":"Modify on Add",
		"dataviewcfg.modifyOnAddTooltip":"In Add mode, whether this item can be modified. If not, set a default value.",
		"dataviewcfg.modifyOnEdit":"Modify on Edit",
		"dataviewcfg.modifyOnEditTooltip":"In Edit mode, whether this item can be modified",
		...
		"dataviewcfg.validateRule":"Validation rule",
		"dataviewcfg.validateRuleTooltip":'Validation rule, Based on jquery validate; demo: [{"type":"maxlength","value":"5","message":"Max length is 5"}]',
		"dataviewcfg.source":"Requirement source",
		"dataviewcfg.sourcePm":"PM",
		"dataviewcfg.sourceDev":"Developer",
		"dataviewcfg.sourceTooltip":"Currently unused",
		"dataviewcfg.valProcess":"Value processing",
		"dataviewcfg.key":"Key",
		"dataviewcfg.keyPath":"Key and path",
		"dataviewcfg.self":"Custom definition",
		"dataviewcfg.valProcessTooltip":"Configure how to map value and json content, key: map to json object first level field; Key and path: map to json path of first key field; self:Custom definition",
		"dataviewcfg.path":"Path",
		"dataviewcfg.script":"Script",
		"dataviewcfg.beforeRender":"Before render",
		"dataviewcfg.beforeRenderTooltip":"Advanced usage, javascript code, eval before render",
		"dataviewcfg.afterRender":"After render",
		"dataviewcfg.afterRenderTooltip":"Advanced usage, javascript code, eval after render",
		"dataviewcfg.extConfig":"Extended configuration",
		"dataviewcfg.extConfigTooltip":"Advanced usage, javascript object, append or override config, key cannot be 'ext'",
