...
public class BpmnConverterTest {
    ...
    public void testConvert() throws IOException {
        ...
        Resource resource = resolver.getResource("classpath:flow/converter/process_1.bpmn");
    ...
    public void testConvertSimple() throws IOException {
        PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        Resource resource = resolver.getResource("classpath:flow/converter/process_1_simple.bpmn");
        Map<String, Object> model = BpmnConverter.convert(resource.getInputStream());
    ...
    public void testConvertResult() {
        ...
        flowEngine.setFlowPath("classpath:flow/converter/flow001.json, classpath:flow/converter/process_1.bpmn");
        flowEngine.init();
