package com.jd.easyflow.flow.bpmn.extension;
...
public class BpmnExtensionTest {
    ...
    public void testExtension() {
        ...
        try {
            reader = XMLInputFactory.newFactory().createXMLStreamReader(this.getClass().getResourceAsStream("/flow/extension/process_1.bpmn"));
    ...
    public void testConvert() throws IOException {
        ...
        Resource resource = resolver.getResource("classpath:flow/extension/process_1.bpmn");
