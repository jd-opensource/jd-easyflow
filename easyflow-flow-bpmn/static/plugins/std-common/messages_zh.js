...
$.extend(J.msg, {
    ...
    "bpmn.conditionType.inclussive":"包容网关",
    ...
    "bpmn.listener":"监听器",
    "bpmn.listenerTooltip":"流程监听器，JSON数组格式，具体参考配置文档",
    "bpmn.filter":"流程过滤器",
    "bpmn.filterTooltip":"流程过滤器，JSON数组格式，具体参考配置文档",
    "bpmn.nodeFilter":"节点过滤器",
    "bpmn.nodeFilterTooltip":"节点过滤器，JSON数组格式，具体参考配置文档",    
    "bpmn.nodePreHandlerFilter":"节点前置处理过滤器",
    "bpmn.nodePreHandlerFilterTooltip":"节点前置处理过滤器，JSON数组格式，具体参考配置文档",        
    "bpmn.nodeActionFilter":"节点动作过滤器",
    "bpmn.nodeActionFilterTooltip":"节点动作过滤器，JSON数组格式，具体参考配置文档",  
    "bpmn.nodePostHandlerFilter":"节点后置处理过滤器",
